<?php
  ...
  $sql1 = "SELECT * FROM arch_orders WHERE id_order='".$_REQUEST['orderid']."'";
  $result = mysqli_query($conn, $sql1);
  $order = mysqli_fetch_array($result);

  $f_address_id=$order['f_address'];
  $sql2 = "SELECT * FROM arch_address WHERE id_address='$f_address_id'";
  $result2 = mysqli_query($conn, $sql2);
  $f_address = mysqli_fetch_array($result2);

  $s_address_id=$order['s_address'];
  $sql3 = "SELECT * FROM arch_address WHERE id_address='$s_address_id'";
  $result3 = mysqli_query($conn, $sql3);
  $s_address = mysqli_fetch_array($result3);

  $cargo_id=$order['id_cargo'];
  $sql4 = "SELECT * FROM arch_cargo WHERE id_cargo='$cargo_id'";
